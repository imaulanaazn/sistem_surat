...
<script>
    ...
    const kopSurat = `
                <div class="kop-surat flex items-center justify-center">
                    <img src="/assets/img/logos/logo_desa.webp" alt="" class="logo-kop w-16 h-16 justify-start">
                    <div class="institusi text-center border-b flex-1">
                        <h2 class="text-lg font-bold uppercase">Pemerintah Desa Contoh</h2>
                        <h3 class="text-base font-semibold uppercase">Kecamatan Banyumas, Kabupaten Banyumas</h3>
                        <p class="text-sm">Alamat: Jl. Raya Desa No. 10, Banyumas 53192</p>
                    </div>
                    <img src="/assets/img/logos/logo_desa.webp" alt="" class="logo-hidden w-16 h-16 justify-start opacity-0">
                </div>`
